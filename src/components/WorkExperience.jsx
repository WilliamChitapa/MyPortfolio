...
const WorkExperience = () => {
    return (
        <section id="work" className=" mt-[-90px]  flex-col
         text-white pt-4 pb-10 md: px-10 flex justify-center items-center" >
            <h2 className="text-4xl font-bold mb-8">Work Experience</h2>
            <div className="relative border-l-4 border-green-500 pl-6 
            sm:pl-6 md:pl-2 lg:pl-8 xl:pl-8">

                <div className="mb-10">
                    <div className="absolute -left-3 w-5 h-5 bg-green-500 rounded-full"></div>
                    <h3 className="text-xl font-semibold">May 2023 - Present</h3>
